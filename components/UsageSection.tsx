  ...
  return (
    <section className="py-24 bg-cream relative overflow-hidden">
      ...
      >
        ...
        <a href="https://www.instagram.com/the_balanced_pantry_lk?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="inline-block border-b-2 border-charcoal text-charcoal font-serif font-bold hover:text-brandRed hover:border-brandRed transition-colors pb-0.5">
